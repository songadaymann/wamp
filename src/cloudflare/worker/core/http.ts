...
export function corsHeaders(request: Request): HeadersInit {
  ...
  const headers: Record<string, string> = {
    'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-Admin-Key, X-Playfun-Session-Token, X-Debug-Force-Cryptopunk-Unlock, X-Guest-User-Id, X-Guest-Recovery-Token',
