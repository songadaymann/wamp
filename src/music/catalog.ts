...
const WAMP_V1_LANES: RoomMusicLane[] = [
  { id: 'drums', label: 'Drums', shortLabel: 'Drums', defaultGain: 0.8 },
  { id: 'bass', label: 'Bass', shortLabel: 'Bass', defaultGain: 0.64 },
  { id: 'arp', label: 'Arp', shortLabel: 'Arp', defaultGain: 0.5 },
  { id: 'hold', label: 'Hold', shortLabel: 'Hold', defaultGain: 0.42 },
  { id: 'melody', label: 'Melody', shortLabel: 'Melody', defaultGain: 0.58 },
];
