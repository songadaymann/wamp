...
export const GAME_OBJECTS: GameObjectConfig[] = [
  ...
  { id: 'tornado_sand',name: 'Sand Tornado',category: 'interactive',      path: 'assets/enemies/tornado_sand.png',frameWidth: 48, frameHeight: 48, frameCount: 8,  fps: 10, bodyWidth: 28, bodyHeight: 40, behavior: 'animated', description: 'Launches player in air.' },
  { id: 'tornado',     name: 'Tornado',     category: 'interactive',      path: 'assets/enemies/tornado.png',     frameWidth: 48, frameHeight: 48, frameCount: 8,  fps: 10, bodyWidth: 28, bodyHeight: 40, behavior: 'animated', description: 'Launches player in air.' },
