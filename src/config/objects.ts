...
export const GAME_OBJECTS: GameObjectConfig[] = [
  ...
  { id: 'crate',       name: 'Crate',       category: 'platform',    path: 'assets/objects/crate.png', frameWidth: 32, frameHeight: 32, frameCount: 4,  fps: 0,  defaultFrame: 0, bodyWidth: 16, bodyHeight: 16, bodyOffsetX: 0, bodyOffsetY: 16, previewWidth: 16, previewHeight: 16, previewOffsetX: 0, previewOffsetY: 16, behavior: 'static',   interaction: 'pushable', description: 'Solid block. Stand on it, push it, or break it with a butt stomp.' },
