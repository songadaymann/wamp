...
export const GAME_OBJECTS: GameObjectConfig[] = [
  ...
  { id: 'trapdoor_locked', name: 'Locked Trapdoor', category: 'interactive', path: 'assets/objects/trapdoor.png', frameWidth: 16, frameHeight: 16, frameCount: 1,  fps: 0,  facingDirection: 'right', bodyWidth: 16, bodyHeight: 16, bodyOffsetX: 0, bodyOffsetY: 0, behavior: 'static',   description: 'A key-gated trapdoor. Collect a key to unlock and pass through.' },
  ...
  { id: MOVING_PLATFORM_ENDPOINT_OBJECT_ID, name: 'Moving Platform Anchor', category: 'interactive', path: 'assets/objects/moving_platform.png', frameWidth: 16, frameHeight: 16, frameCount: 1, fps: 0, bodyWidth: 0, bodyHeight: 0, behavior: 'static', description: 'Editor marker for linked moving platforms. Hidden during play.' },
