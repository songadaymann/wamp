...
export const GAME_OBJECTS: GameObjectConfig[] = [
  ...
  { id: 'kitkat',      name: 'KitKat',      category: 'collectible', path: 'assets/objects/kitkat.png',      frameWidth: 64, frameHeight: 32, frameCount: 1,  fps: 0,  bodyWidth: 42, bodyHeight: 24, behavior: 'static',   description: 'Collectible candy bar.' },
