...
export const GAME_OBJECTS: GameObjectConfig[] = [
  ...
  { id: 'cage',        name: 'Cage',        category: 'platform',    path: 'assets/objects/cage.png',        frameWidth: 18, frameHeight: 32, frameCount: 5,  fps: 10,  defaultFrame: 0, bodyWidth: 16, bodyHeight: 16, bodyOffsetX: 2, bodyOffsetY: 16, behavior: 'static', placeUsingPreviewBounds: true, description: 'Tall cage prop. Solid collision.' },
