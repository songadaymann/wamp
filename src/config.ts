...
export interface GameObjectConfig {
  ...
  behavior: 'static' | 'patrol' | 'fly' | 'bounce' | 'animated';
...
export const GAME_OBJECTS: GameObjectConfig[] = [
  ...
  // ── Hazards ──
  { id: 'spikes',      name: 'Spikes',      category: 'hazard',      path: 'assets/enemies/spikes.png',      frameWidth: 16, frameHeight: 16, frameCount: 1,  fps: 0,  bodyWidth: 14, bodyHeight: 10, behavior: 'static',   description: 'Static hazard. Kills on contact.' },
  ...
  // ── Enemies ──
  { id: 'slime_blue',  name: 'Blue Slime',  category: 'enemy',       path: 'assets/enemies/slime_blue.png',  frameWidth: 16, frameHeight: 32, frameCount: 5,  fps: 6,  bodyWidth: 14, bodyHeight: 20, behavior: 'patrol',   description: 'Patrols back and forth. Kills on contact.' },
  { id: 'slime_red',   name: 'Red Slime',   category: 'enemy',       path: 'assets/enemies/slime_red.png',   frameWidth: 16, frameHeight: 32, frameCount: 5,  fps: 6,  bodyWidth: 14, bodyHeight: 20, behavior: 'patrol',   description: 'Patrols back and forth. Kills on contact.' },
  { id: 'bat',         name: 'Bat',         category: 'enemy',       path: 'assets/enemies/bat.png',         frameWidth: 32, frameHeight: 32, frameCount: 8,  fps: 8,  bodyWidth: 24, bodyHeight: 20, behavior: 'fly',      description: 'Flies in a wave pattern. Kills on contact.' },
  { id: 'crab',        name: 'Crab',        category: 'enemy',       path: 'assets/enemies/crab.png',        frameWidth: 16, frameHeight: 48, frameCount: 6,  fps: 6,  bodyWidth: 14, bodyHeight: 24, behavior: 'patrol',   description: 'Patrols back and forth. Kills on contact.' },
  { id: 'bird',        name: 'Bird',        category: 'enemy',       path: 'assets/enemies/bird.png',        frameWidth: 32, frameHeight: 32, frameCount: 4,  fps: 10, bodyWidth: 24, bodyHeight: 20, behavior: 'fly',      description: 'Flies in a wave pattern. Kills on contact.' },
  { id: 'fish',        name: 'Fish',        category: 'enemy',       path: 'assets/enemies/fish.png',        frameWidth: 16, frameHeight: 16, frameCount: 6,  fps: 8,  bodyWidth: 14, bodyHeight: 12, behavior: 'bounce',   description: 'Jumps up and down. Kills on contact.' },
  { id: 'frog',        name: 'Frog',        category: 'enemy',       path: 'assets/enemies/frog.png',        frameWidth: 32, frameHeight: 32, frameCount: 4,  fps: 6,  bodyWidth: 24, bodyHeight: 24, behavior: 'bounce',   description: 'Hops around periodically. Kills on contact.' },
  { id: 'snake',       name: 'Snake',       category: 'enemy',       path: 'assets/enemies/snake.png',       frameWidth: 32, frameHeight: 32, frameCount: 4,  fps: 6,  bodyWidth: 24, bodyHeight: 20, behavior: 'patrol',   description: 'Patrols back and forth. Kills on contact.' },
  { id: 'penguin',     name: 'Penguin',     category: 'enemy',       path: 'assets/enemies/penguin.png',     frameWidth: 32, frameHeight: 32, frameCount: 4,  fps: 6,  bodyWidth: 24, bodyHeight: 28, behavior: 'patrol',   description: 'Patrols back and forth. Kills on contact.' },
  ...
  { id: 'clouds_deco', name: 'Clouds',      category: 'decoration',  path: 'assets/deco/clouds.png',         frameWidth: 32, frameHeight: 48, frameCount: 2,  fps: 0,  bodyWidth: 0,  bodyHeight: 0,  behavior: 'static',   description: 'Cloud decoration. No collision.' },
];
