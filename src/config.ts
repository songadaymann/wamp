...
export const GAME_OBJECTS: GameObjectConfig[] = [
  ...
  { id: 'cage',        name: 'Cage',        category: 'platform',    path: 'assets/objects/cage.png',        frameWidth: 18, frameHeight: 32, frameCount: 5,  fps: 0,  defaultFrame: 0, bodyWidth: 14, bodyHeight: 16, bodyOffsetX: 1, bodyOffsetY: 2, behavior: 'static',   description: 'Tall cage prop. Solid collision.' },
  ...
  { id: 'clouds_deco', name: 'Clouds',      category: 'decoration',  path: 'assets/deco/clouds.png',         frameWidth: 64, frameHeight: 16, frameCount: 1,  fps: 0,  bodyWidth: 0,  bodyHeight: 0,  behavior: 'static',   description: 'Cloud decoration. No collision.' },
];
