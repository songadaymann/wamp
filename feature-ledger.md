...
| Music system | `continue-from-branch` | Live baseline: `main` (music system landed and production deployed on 2026-04-06). Canonical follow-up branch: `feature/music-phrase-ux-2026-04-06` from current `main`. Reference only: `feature/music-sequencer` (`1aa6d98`), `safety/main-based-room-sequencer-2026-04-02`, `safety/advanced-room-sequencer-2026-04-02` (`146f5a6`), `safety/advanced-room-sequencer-followup-2026-04-02` (`acc9a9c`), `safety/advanced-room-sequencer-save-recovery-2026-04-02` (`8ec87e6`), `safety/room-music-followup-snapshot-2026-04-01` (`37c1687`) | Production: `https://wamp.land` API: `https://api.wamp.land` | The phrase-library / arranger / room-music system is live on `main` and in production. The remaining active follow-up is a narrower phrase UX pass: replace the inline publish-name affordance with `New / Edit / Save`, autosave into fresh phrases, and infer the current phrase key on save while preserving actual MIDI pitches. Older music safety / snapshot branches are historical only. The earlier merged test branches `integration/music-latest-main-port`, `release/music-main-2026-04-06`, and `safety/music-phrase-library-tileset-theme-2026-04-05` were already pruned. | Continue only on `feature/music-phrase-ux-2026-04-06`, QA the new phrase workflow in a real editor session, then land it as a narrow post-launch music UX follow-up if it feels right. |
