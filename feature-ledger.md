...
| Music system | `testing` | Canonical: `integration/music-latest-main-port` -> `6f4334c` plus current local phrase-library follow-up worktree state. Reference only: `feature/music-sequencer` (`1aa6d98`), `safety/main-based-room-sequencer-2026-04-02`, `safety/advanced-room-sequencer-2026-04-02` (`146f5a6`), `safety/advanced-room-sequencer-followup-2026-04-02` (`acc9a9c`), `safety/advanced-room-sequencer-save-recovery-2026-04-02` (`8ec87e6`), `safety/room-music-followup-snapshot-2026-04-01` (`37c1687`) | Pages: `https://safety-music-tileset-theme.wampland.pages.dev` Worker: `https://everybodys-platformer-safety.novox-robot.workers.dev` | The clean continuation line moved off the older April 2 main-based music branch and onto the latest-main graft. Current work there adds the phrase library API/schema, key-aware phrase import, the arranger overlay, Mario Paint arrangement cues, swing control, sequencer-side publish-name metadata, and the April 6 Roland MT-32 sample-backed drum spike on top of the sequencer runtime. Safety D1 migration `0019_music_phrase_library.sql` and the new `/api/music/phrases` routes are deployed on the shared safety stack, and the current safety Worker version after the April 6 full-stack redeploy is `0367e767-6120-4382-af7d-912934801135`. Older music safety/snapshot branches are now reference history only and should not be revived directly. | Continue QA on `integration/music-latest-main-port` against the live safety stack, verify publish/import/persistence end-to-end and MT-32 drum feel in the editor, then prune the older music safety branches only after this latest-main line is accepted as the canonical test target. |
