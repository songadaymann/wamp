...
| NPC object class and NPC Quests | `codex/npc-object-quest` | Local implementation complete; NPCs now respond to special-tile surfaces and forces, tornadoes, quicksand, and lethal hazards according to defeat mode; Player Collision and Friendly Fire persist end to end; Jimothy temporarily uses the tracked brown bear 4x2 sheet; verified ready against the public API | http://127.0.0.1:3000/ | Replace `assets/enemies/bear_brown.png` with `assets/npc/jimothy.png` when final art arrives |
