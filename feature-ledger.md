...
| --- | --- | --- | --- | --- |
| Performance and code health | `codex/performance-code-health-2026-07-17` | All waves safety-deployed; explicit D1/API, 60-second runtime, and 48/150-peer gates pass | https://everybodys-platformer-safety.novox-robot.workers.dev | Review branch for production promotion one wave at a time |
